...
const UsersBooking = () => {
  const{data: realty, isLoading: isRealtyLoading, isError: isRealtyError} = useGetUsersRealtyQuery({params: '?type=reservations'});
  // @ts-ignore
  ...
  return (<Container style={{margin:'40px auto'}}>
    ...
    <Typography sx={{mt:2,mb:2}}>Users booking info</Typography>
